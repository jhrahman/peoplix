...
| 41 | Open `/audit-log` with a slow connection or throttled network | Simulated slow load | A loading skeleton is shown while data fetches, instead of a blank page |
